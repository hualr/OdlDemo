...
public class OdlDemoCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(OdlDemoCliTestCommand.class);
    protected final OdlDemoCliCommands service;

    public OdlDemoCliTestCommand(final OdlDemoCliCommands service) {
